...
* 1.0.1      140126  KMOTEAN     Added filter to have unique ROUT/Adjusted function calculateNextDeliveryDate to take date according to timezone
*/
...
public class LstGscARIANE extends ExtendM3Transaction {
  ...
  public LstGscARIANE(MIAPI mi, DatabaseAPI database, ProgramAPI program, MICallerAPI miCaller) {
    this.mi = mi
  ...
  */
  void mms059ListApiCall(String SPLM,String priority){
    ...
    miCaller.setListMaxRecords(100)//maxRexords set to 100
  ...
  */
  void searchAllValidRoutesForCustomerPO1PO2(){
    ...
    //removed expression ="5" due to anomalies in DRODPR->Value is sometimes " 5"
    ...
    queryDRODPR.readAll(containerDRODPR,1,100, { DBContainer container ->
      //added if condition ="5" due to anomalies in DRODPR->Value is sometimes " 5"
  ...
  */
  ...
  double readOOLINE(String whlo, String rout, String rodn, String a030) {
    ...
    .and(expression.eq("OBDSDT", currentDate))
