...
public class LstOrderETAI extends ExtendM3Transaction {
  ...
  public LstOrderETAI(MIAPI mi, DatabaseAPI database, ProgramAPI program, MICallerAPI miCaller) {
    this.mi = mi
  ...
  public void main() {
    ...
    if(stat610!="20"){
      ...
      mi.outData.put('CRAM', "0.00")
      mi.outData.put('CONQ', "0")
      mi.outData.put('WHL2', whlo610)
      getwarehouseName(whlo610)
      mi.outData.put('WHN2', whnm610)
      mi.write()
      return
    }
