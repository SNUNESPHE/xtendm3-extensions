...
public class LstRfoARIANE extends ExtendM3Transaction {
  ...
  public LstRfoARIANE(MIAPI mi, DatabaseAPI database, ProgramAPI program, MICallerAPI miCaller) {
    this.mi = mi
  ...
  public void main() {
    ...
    if(itemFound){
      ois320MIGetLine(inCONO.toString(),inCUNO, correctITNO)//getPrices
    }
  ...
  */
  ...
  /**
  * @mms025ApiCall - LstItems from MMS025 
  * @params - popn,alwt
  * @returns -
  */
  ...
  */
  void checkChaineCommercialeOIS039(){
   ...
   /**
  * @checkAssortimentArticle - Checks assortment for item
  * @params -
  * @returns -true/false
  */
