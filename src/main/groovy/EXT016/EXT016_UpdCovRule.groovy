/****************************************************************************************
 Extension Name: EXT016MI/UpdCovRule
...
public class UpdCovRule extends ExtendM3Transaction {
  ...
  public UpdCovRule(MIAPI mi, ProgramAPI program, DatabaseAPI database) {
    this.mi = mi
  ...
  public void main() {
    ...
    container.setInt("EXTRCH", inTRCH)
