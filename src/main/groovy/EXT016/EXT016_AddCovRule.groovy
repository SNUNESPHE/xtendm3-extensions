/****************************************************************************************
 Extension Name: EXT016MI/AddCovRule
...
public class AddCovRule extends ExtendM3Transaction {
  ...
  public AddCovRule(MIAPI mi, ProgramAPI program, DatabaseAPI database) {
    this.mi = mi
  ...
  public void main() {
    ...
    DBAction insertQuery = database.table("EXT016")
      .index("00")
      .build()
    ...
    insertContainer.set("EXTRCH", inTRCH)
