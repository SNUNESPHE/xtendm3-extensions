/****************************************************************************************
 Extension Name: EXT017MI/AddItem
 Type: ExtendM3Transaction
 Script Author: Tovonirina ANDRIANARIVELo
 Date: 2025-01-22
 Description:
 * Add item into the table EXT017. 
...
public class AddItem extends ExtendM3Transaction {
  ...
  public void main() {
    ...
    DBAction insertQuery = database.table("EXT017")
      .index("00")
      .build()
    ...
    insertContainer.set("EXCONT", inCONT)
